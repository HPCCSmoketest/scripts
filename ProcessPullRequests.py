...
def GetPullReqCommitId(prid):
    retVal = ''
    try:
        myProc = subprocess.Popen(['curl --request GET -H "Content-Type: application/json" -H "Authorization: token cdc4978bf527522f76d64087d39cf187c142f08d" https://api.github.com/repos/hpcc-systems/HPCC-Platform/pulls/%s' % (prid)],  shell=True,  bufsize=8192,  stdout=subprocess.PIPE,  stderr=subprocess.PIPE)
...
def GetOpenPulls(knownPullRequests):
    ...
    for pr in pulls:
        ...
        prs[prid]['addComment']['cmd'] = 'curl -H "Content-Type: application/json" '\
                                '-H "Authorization: token cdc4978bf527522f76d64087d39cf187c142f08d" '\
                                ' --data '
...
class MessageId(object):
    ...
    def removeLastMsgFromGithub(self):
        ...
        if not last == 'None':
            ...
            cmd = 'curl -H "Content-Type: application/json" -H "Authorization: token cdc4978bf527522f76d64087d39cf187c142f08d"  --request DELETE https://api.github.com/repos/hpcc-systems/HPCC-Platform/issues/comments/'+last
