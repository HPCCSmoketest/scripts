...
GLOBAL_EXCLUSION="--ef pipefail.ecl,prefetch4.ecl,loopthor2.ecl,genjoin2.ecl,genjoin3.ecl,key.ecl,keydiff1.ecl,teststdlibrary.ecl,javaembed_ex5.ecl -e=embedded-r,embedded-js,3rdpartyservice,mongodb"
PYTHON_PLUGIN=''
