...
GLOBAL_EXCLUSION="--ef pipefail.ecl,prefetch4.ecl,loopthor2.ecl,genjoin2.ecl,genjoin3.ecl,key.ecl,keydiff1.ecl -e=embedded-r,embedded-js,3rdpartyservice,mongodb"
PYTHON_PLUGIN=''
