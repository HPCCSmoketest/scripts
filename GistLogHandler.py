...
class GistLogHandler(object):
    ...
    def __init__(self,  resultFile=None,  verbose=True):
    ...
    def myPrint(self, Msg, *Args):
        ...
        self.resultFile.write(format % tuple([Msg]+map(str,Args)))
        self.resultFile.flush()
    ...
    def createGist(self,  prId, commitId=None):
        ...
        cmd = 'curl -H "Content-Type: application/json" -H "Authorization: token cdc4978bf527522f76d64087d39cf187c142f08d" --data ' + msg +' https://api.github.com/gists'
        ...
        try:
            if os.path.exists(self.gistsIdFileName):
                ...
                for index in range(numOfGists):
                    ...
                    cmd = 'curl -H "Content-Type: application/json" -H "Authorization: token cdc4978bf527522f76d64087d39cf187c142f08d" --request DELETE https://api.github.com/gists/' + id
                    result = self.execCmd(cmd)
